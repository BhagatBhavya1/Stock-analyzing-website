...
import math
import pandas as pd
from History_NSE.static_data import *
import urllib.parse
import concurrent.futures
import logging
# from NSEDownload.indices import get_historical_index_url

HISTORICAL_DATA_URL = 'https://www.nseindia.com/api/historical/cm/equity?series=[%22EQ%22]&'
# bhavya = 'https://www.nseindia.com/api//products/dynaContent/equities/indices/historicalindices.jsp'
